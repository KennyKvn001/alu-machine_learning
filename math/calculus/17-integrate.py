...
def poly_integral(poly, C=0):
    """
    This function computes the integral of a polynomial represented by a list of coefficients.

    Parameters:
    - poly: A list of coefficients, where the index of each element represents the power of x.
    - C: An optional integer representing the constant of integration (default is 0).

    Returns:
    - A new list of coefficients representing the integral of the polynomial.
      If the result contains a term with a whole number, it should be returned as an integer.
      If the input poly or C are not valid, the function returns None.
    """
